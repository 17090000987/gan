...
var Online={
    ...
    play:function(url,type){
        ...
        if(!Online.player){
            ...
            Online.player = new GanPlayer(video,wsUrl);
        }
...
Tab.current.page.onCreate=function () {
    ...
    // Online.h5player = new MediaSourcePlayer(document.getElementById("video"));
    // Online.h5player.play("media/online/frag_bunny.mp4");
    ...
    var wsUrl = "ws://" + window.location.host + "/ws/rtsp"
    Online.player = new GanPlayer(document.getElementById("video"),wsUrl);
    Online.player.playFile("/file/h264/frag_bunny.mp4")
}
