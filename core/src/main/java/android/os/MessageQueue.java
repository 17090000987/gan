...
public final class MessageQueue {
    ...
    private void nativeDestroy(long ptr){
    ...
    private boolean nativeIsPolling(long ptr){
        return mIsPolling;
    }
    ...
    Message next() {
        ...
        FileLogger logger = FileLogger.getInfoLogger();
            ...
            synchronized (this) {
                ...
                if (msg != null) {
                    if (now < msg.when) {
                        ...
                        msg.next = null;
                        logger.log("Returning message: " + msg);
                        msg.markInUse();
                        return msg;
                    }
                } else {
    ...
    boolean enqueueMessage(Message msg, long when) {
        ...
        synchronized (this) {
            if (mQuitting) {
                ...
                DebugLog.debug("IllegalStateException e:"+e.getMessage());
                msg.recycle();
                return false;
            }
