...
WebGLPlayer.prototype.notifyScreenSizeChanged = function(){
    var width = screen.width;
    var height = screen.height;
    var rate = this.frame_width / this.frame_height;
    var cw = 0, ch = 0;
    ...
    this.canvas.setAttribute("width", (cw)+"px");
    this.canvas.setAttribute("height", (ch)+"px");
}
